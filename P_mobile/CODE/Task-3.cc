/*You basically have 3 node and there is switch in path from highspeed link to low speed link.This file gives you Cwnd and throughput. The link rates are 100Mbps and 10Mbps*/
#include <iostream>
#include <string>
#include <fstream>
#include <fstream>
